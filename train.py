...
from util.cable_seg import CABLE_SEG
...
def main_worker(gpu, ngpus_per_node, argss):
    ...
    train_data = CABLE_SEG(split='train', data_root=args.data_root, test_areas=args.test_areas, voxel_size=args.voxel_size, voxel_max=args.voxel_max, transform=train_transform, shuffle_index=True, loop=args.loop)
    ...
    val_transform = None
    val_data = CABLE_SEG(split='val', data_root=args.data_root, test_areas=args.test_areas, voxel_size=args.voxel_size, voxel_max=800000, transform=val_transform)
